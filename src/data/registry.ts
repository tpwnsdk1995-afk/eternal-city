...
import { assaultRaid, assaultX2, assaultX3, assaultX4 } from './assaults/assault-x-plus';
...
export const ASSAULTS: AssaultDef[] = [...BASE_ASSAULTS, ...BASE_ASSAULTS.map(advancedOf), assaultX, assaultX2, assaultX3, assaultX4, assaultRaid];
