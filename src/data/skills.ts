...
export const SKILLS: SkillDef[] = [
  ...
  },
  {
    ...
    price: 30_000,
    maxRank: 5,
    modsPerRank: { defensePct: 0.03 },
    desc: '방어력이 랭크당 3% 증가한다.',
    iconTex: TEX.icon_skill_passive,
  },
  {
    id: 'skill_focus',
    ...
    price: 18_000,
    maxRank: 5,
    modsPerRank: { maxApPct: 0.05, critPct: 0.005 },
    desc: '최대 행동력 5%, 치명타 0.5%가 랭크당 증가한다.',
    iconTex: TEX.icon_skill_passive,
  },
  {
    id: 'skill_adrenaline',
    ...
    maxRank: 5,
    apDrainPerSec: 3,
    modsPerRank: { moveSpeedPct: 0.04, attackSpeedPct: 0.02 },
    desc: '활성 중 이동속도 4%, 공격속도 2%가 랭크당 증가한다. 행동력을 초당 3 소모한다.',
    iconTex: TEX.icon_skill_active,
  },
  {
    id: 'skill_iron_wall',
    ...
    maxRank: 5,
    apDrainPerSec: 4,
    modsPerRank: { defensePct: 0.05, maxHpPct: 0.01 },
    desc: '활성 중 방어력 5%, 최대 생명력 1%가 랭크당 증가한다. 행동력을 초당 4 소모한다.',
    iconTex: TEX.icon_skill_active,
  },
  // ---------------------------------------------------------------- 웨폰 마스터리 (분류별)
