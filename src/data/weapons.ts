...
export const WEAPONS: WeaponDef[] = [
  // ---------------------------------------------------------------- 권총
  W({ id: 'glock17', name: 'Glock 17', class: '권총', caliber: '9mm', baseDamage: 12, rpm: 240, range: 420, spreadDeg: 2.5, baseAccuracy: 0.85, weightKg: 0.9, reqLevel: 1, price: 8_000, tex: TEX.icon_glock17, iconTex: TEX.icon_glock17 }),
  W({ id: 'm1911', name: 'Colt M1911', class: '권총', caliber: '.45ACP', baseDamage: 17, rpm: 180, range: 400, spreadDeg: 3, baseAccuracy: 0.82, weightKg: 1.1, reqLevel: 3, price: 12_000, tex: TEX.icon_m1911, iconTex: TEX.icon_m1911 }),
  // ---------------------------------------------------------------- 기관단총
  W({ id: 'mp5', name: 'H&K MP5', class: '기관단총', caliber: '9mm', baseDamage: 9, rpm: 600, range: 380, spreadDeg: 4.5, baseAccuracy: 0.72, weightKg: 2.9, reqLevel: 5, price: 35_000, tex: TEX.icon_mp5, iconTex: TEX.icon_mp5 }),
  W({ id: 'uzi', name: 'IMI UZI', class: '기관단총', caliber: '9mm', baseDamage: 8, rpm: 700, range: 340, spreadDeg: 6, baseAccuracy: 0.65, weightKg: 3.2, reqLevel: 4, price: 28_000, tex: TEX.icon_uzi, iconTex: TEX.icon_uzi }),
  // ---------------------------------------------------------------- 돌격소총
  W({ id: 'm16a2', name: 'M16A2', class: '돌격소총', caliber: '5.56mm', baseDamage: 16, rpm: 700, range: 480, spreadDeg: 3, baseAccuracy: 0.78, weightKg: 3.6, reqLevel: 8, price: 42_000, tex: TEX.icon_m16, iconTex: TEX.icon_m16 }),
  W({ id: 'ak47', name: 'AK-47', class: '돌격소총', caliber: '7.62mm', baseDamage: 20, rpm: 600, range: 460, spreadDeg: 4, baseAccuracy: 0.72, weightKg: 4.3, reqLevel: 12, price: 55_000, tex: TEX.icon_ak47, iconTex: TEX.icon_ak47 }),
  ...
  // ---------------------------------------------------------------- 기관총 (rpm 300 고정)
  W({ id: 'm249', name: 'M249 SAW', class: '기관총', caliber: '5.56mm', baseDamage: 17, rpm: 300, range: 480, spreadDeg: 4.5, baseAccuracy: 0.65, weightKg: 7.5, reqLevel: 15, reqTechGrade: 2, price: 95_000, tex: TEX.icon_mg, iconTex: TEX.icon_mg }),
  W({ id: 'm60', name: 'M60', class: '기관총', caliber: '7.62mm', baseDamage: 22, rpm: 300, range: 500, spreadDeg: 5.5, baseAccuracy: 0.6, weightKg: 10.5, reqLevel: 18, reqTechGrade: 2, price: 120_000, tex: TEX.icon_mg, iconTex: TEX.icon_mg }),
  // ---------------------------------------------------------------- 근접무기
  ...
  // ---------------------------------------------------------------- 불법무기 (암거래상)
  W({ id: 'tec9', name: 'TEC-9 (개조)', class: '기관단총', caliber: '9mm', baseDamage: 11, rpm: 900, range: 300, spreadDeg: 8, baseAccuracy: 0.55, weightKg: 1.6, reqLevel: 6, illegal: true, price: 40_000, tex: TEX.icon_uzi, iconTex: TEX.icon_uzi }),
