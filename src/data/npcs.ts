...
export const NPCS: NpcDef[] = [
  ...
  },
  {
    ...
    assaults: ['assault-a', 'assault-b', 'assault-c', 'assault-d', 'assault-e', 'assault-f', 'assault-a-adv', 'assault-b-adv', 'assault-c-adv', 'assault-d-adv', 'assault-e-adv', 'assault-f-adv', 'assault-x', 'assault-x2', 'assault-x3', 'assault-x4', 'assault-raid'],
  },
];
